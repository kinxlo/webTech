  ...
  <main>
          ...
          >
            ...
            <section class="mt-16 mt-md-0">
              <p class="mr-md-10 white--text">
                Always on the lookout for the hi-tech advancements. Build not
                only a
                <br />
      ...
      <v-layout justify-center fill-height class="cc-wrapper">
        ...
        >
          ...
          <div class="d-flex flex-column flex-md-row">
            <v-btn color="accent" x-large class="px-7 rounded-0 mr-md-5 my-5"
              >Start Now</v-btn
            >
            <v-btn
              color="accent"
              outlined
              x-large
              class="px-7 rounded-0 mr-md-5 my-5"
              ><span class="white--text">Learn More</span></v-btn
            >
          </div>
        </v-sheet>
    ...
    <v-layout flex-column class="cc-wrapper v-spacing">
      <div class="py-5 text-center mb-16">
        <h2
          class="font-m accent--text left_border pl-7 py-2 font-weight-bold d-inline font-header"
        >
          Our
        </h2>
      ...
      <v-row no-gutters>
        <v-col cols="12" md="7" lg="8" class="pr-md-3">
          ...
          <v-layout flex-column class="pa-md-16">
        ...
        <v-col cols="12" md="5" lg="4" class="pl-md-3 mt-16 mt-md-0">
          ...
          >
            ...
            >
              ...
              <div
                class="info--text my-3 white--text d-flex justify-space-between"
              >
                <span class="text-capitalize mr-md-16 text-caption"
                  >emmajohnson</span
                >
